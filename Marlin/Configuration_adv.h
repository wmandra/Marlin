...
// @section lcd
  ...
  #define ULTIPANEL_FEEDRATE // Display last requested feedrate on info screen. ULTIPANEL_FEEDMULTIPLY must be disabled
#endif
...
//
  ...
  #define JUNCTION_DEVIATION_MM DEFAULT_JUNCTION_DEVIATION
#endif
 ...
 */
  ...
  #define LIN_ADVANCE_K LINEAR_ADVANCE_K0  // Unit: mm compression per 1mm/s extruder speed
...
/**
 * Auto-report fan speeds when changed
 */
#define AUTO_REPORT_FANSPEEDS
