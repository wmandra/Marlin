...
#define STRING_CONFIG_H_AUTHOR "(Sys0p)" // Who made the changes.
...
#elif ENABLED(TH3D_HOTEND_THERMISTER)
...
#if ENABLED(TH3D_BED_THERMISTER)
 ...
 */
#define XY_MOTOR_STEPS (XY_FULL_STEPS * XY_MICROSTEPS)
#define Z_MOTOR_STEPS (Z_FULL_STEPS * Z_MICROSTEPS)
#define XY_STEPS (XY_MOTOR_STEPS / (XY_PULLEY_PITCH * XY_PULLEY_TEETH))
#define Z_STEPS (Z_MOTOR_STEPS / Z_ROD_PITCH * Z_GEAR_RATIO)

 #if ENABLED(TITAN_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, TITAN_EXTRUDER_ESTEPS }
#else
  #if ENABLED(CUSTOM_ESTEPS)
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, CUSTOM_ESTEPS_VALUE }
  #else
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, 93 }
  #endif
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X MANUAL_MESH_LEVELING_POINTS    // Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
